...
const translateSelectConfigEN = (key: string | number, ...args: any[]) => {
    //@ts-ignore
    const translation = selectConfigDataEN[key];
    if(typeof translation === "function") return translation(args);
    else return translation;
};

module.exports = translateSelectConfigEN;
